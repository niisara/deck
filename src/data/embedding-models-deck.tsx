...
export const embeddingModelsDeck: Deck = {
  ...
  slides: [
    ...
    },
    {
      ...
      content: (
        <div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '25px', fontSize: '0.9em', maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '15px', padding: '15px', backgroundColor: 'rgba(240, 98, 146, 0.1)', borderRadius: '10px', gridColumn: '1 / -1', maxWidth: '400px', margin: '0 auto' }}>
