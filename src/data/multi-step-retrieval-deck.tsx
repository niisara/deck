  ...
  slides: [
    {
      ...
      content: (
        <div>
          ...
          <div style={{ marginTop: '40px', fontSize: '0.9em', display: 'flex', gap: '20px', justifyContent: 'center', flexWrap: 'wrap' }}>
        ...
        <div>
          ...
          <div style={{ textAlign: 'left', maxWidth: '950px', margin: '0 auto', fontSize: '0.8em' }}>
            ...
            <div style={{ display: 'flex', gap: '40px', marginTop: '20px', fontSize: '0.85em' }}>
              ...
              <div style={{ flex: 1 }}>
                <p><SvgIcon iconName="duo-circle-exclamation" sizeName="1x" style={{ color: '#ffb74d', verticalAlign: 'middle' }} /> <strong>Cons:</strong></p>
                <ul style={{ fontSize: '0.9em' }}>
    ...
    },
    {
      ...
      content: (
        <div style={{ textAlign: 'left', maxWidth: '1100px', margin: '0 auto', fontSize: '0.75em' }}>
          ...
          <div style={{ marginTop: '25px', padding: '20px', background: 'rgba(186, 104, 200, 0.2)', borderRadius: '8px', textAlign: 'center' }}>
