...
export const vectorIndexingDeck: Deck = {
  ...
  slides: [
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div style={{ textAlign: 'left', maxWidth: '900px', margin: '0 auto', fontSize: '0.75em' }}>
      ...
      content: (
        <div>
          ...
          <div style={{ textAlign: 'left', maxWidth: '900px', margin: '0 auto', fontSize: '0.75em' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '12px' }}>
              <div style={{ padding: '10px', backgroundColor: 'rgba(66, 133, 244, 0.1)', borderRadius: '8px', textAlign: 'center' }}>
              ...
              <div style={{ padding: '10px', backgroundColor: 'rgba(52, 168, 83, 0.1)', borderRadius: '8px', textAlign: 'center' }}>
              ...
              <div style={{ padding: '10px', backgroundColor: 'rgba(251, 188, 5, 0.1)', borderRadius: '8px', textAlign: 'center' }}>
      ...
      content: (
        <div>
          ...
          <div style={{ textAlign: 'left', maxWidth: '900px', margin: '0 auto', fontSize: '0.75em' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '12px' }}>
              <div style={{ padding: '10px', backgroundColor: 'rgba(46, 204, 113, 0.1)', borderRadius: '8px', textAlign: 'center' }}>
              ...
              <div style={{ padding: '10px', backgroundColor: 'rgba(52, 152, 219, 0.1)', borderRadius: '8px', textAlign: 'center' }}>
              ...
              <div style={{ padding: '10px', backgroundColor: 'rgba(155, 89, 182, 0.1)', borderRadius: '8px', textAlign: 'center' }}>
    ...
    },
    {
      ...
      content: (
        <div>
          <div style={{ textAlign: 'left', maxWidth: '950px', margin: '0 auto', fontSize: '0.7em' }}>
