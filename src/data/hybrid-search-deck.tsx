  ...
  slides: [
    {
      ...
      content: (
        <div>
          ...
          <div style={{ marginTop: '40px', fontSize: '0.9em', display: 'flex', gap: '15px', justifyContent: 'center', flexWrap: 'wrap', maxWidth: '900px', margin: '40px auto' }}>
    ...
    },
    {
      ...
      content: (
        <div style={{ textAlign: 'left', maxWidth: '1000px', margin: '0 auto', fontSize: '0.9em' }}>
        ...
        <div>
          ...
          <div style={{ textAlign: 'left', maxWidth: '950px', margin: '0 auto', fontSize: '0.8em' }}>
            ...
            <div style={{ display: 'flex', gap: '40px', marginTop: '20px', fontSize: '0.85em' }}>
              <div style={{ flex: 1 }}>
                <p><SvgIcon iconName="duo-circle-check" sizeName="1x" style={{ color: '#81c784', verticalAlign: 'middle' }} darkModeInvert={true} /> <strong>Strengths:</strong></p>
              ...
              <div style={{ flex: 1 }}>
                <p><SvgIcon iconName="duo-circle-exclamation" sizeName="1x" style={{ color: '#ffb74d', verticalAlign: 'middle' }} darkModeInvert={true} /> <strong>Limitations:</strong></p>
                <ul style={{ fontSize: '0.9em' }}>
    ...
    },
    {
      ...
      content: (
        <div style={{ textAlign: 'left', maxWidth: '1100px', margin: '0 auto', fontSize: '0.75em' }}>
          ...
          <div style={{ marginTop: '25px', padding: '20px', background: 'rgba(79, 195, 247, 0.2)', borderRadius: '8px', textAlign: 'center' }}>
