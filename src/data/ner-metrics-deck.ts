  ...
  slides: [
    ...
    },
    {
      ...
      content: `
        ...
        <h3>Formula</h3>
        <p>\\[F1 = \\frac{2 \\times (\\text{Precision} \\times \\text{Recall})}{\\text{Precision} + \\text{Recall}}\\]</p>
    ...
    },
    {
      ...
      content: `
        ...
        <h3>Formula</h3>
        <p>\\[\\text{EM}_i = \\begin{cases} 1 & \\text{if predicted set == gold set} \\\\ 0 & \\text{otherwise} \\end{cases}\\]</p>
        <p>\\[\\text{Exact Match Score} = \\text{mean}(\\text{EM}_i)\\]</p>
    ...
    },
    {
      ...
      content: `
        ...
        <h3>How It Works</h3>
        <p>\\[\\text{IoU} = \\frac{|\\text{tokens}_\\text{overlap}|}{|\\text{tokens}_\\text{union}|}\\]</p>
        <p>Define a match if \\(\\text{IoU} \\geq \\tau\\) (common \\(\\tau = 0.5\\)) and types match</p>
    ...
    },
    {
      ...
      content: `
        ...
        <h3>Formula</h3>
        <p>\\[\\text{Accuracy} = \\frac{\\text{# gold entities with correct type}}{\\text{total gold entities}}\\]</p>
