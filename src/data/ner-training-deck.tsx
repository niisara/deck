  ...
  slides: [
    {
      ...
      content: (
        <div>
          ...
          <div style={{ display: 'flex', gap: '30px', justifyContent: 'center', marginTop: '50px', fontSize: '0.9em' }}>
            <div>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div style={{ textAlign: 'left', maxWidth: '900px', margin: '0 auto', fontSize: '1em' }}>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div style={{ textAlign: 'left', maxWidth: '800px', margin: '0 auto', fontSize: '0.95em' }}>
