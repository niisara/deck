              ...
              <div>
                ...
                <div style={{ marginTop: '12px', padding: '10px', backgroundColor: 'rgba(38, 198, 218, 0.1)', borderRadius: '8px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px', marginTop: '8px', fontSize: '0.9em' }}>
                    <div style={{ textAlign: 'center' }}>Policy: <strong>0.95</strong></div>
                    <div style={{ textAlign: 'center' }}>KB: <strong>0.80</strong></div>
                    <div style={{ textAlign: 'center' }}>Email: <strong>0.60</strong></div>
                    <div style={{ textAlign: 'center' }}>Chat: <strong>0.20</strong></div>
                  </div>
                </div>
              </div>
