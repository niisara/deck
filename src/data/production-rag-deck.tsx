  ...
  slides: [
    {
      ...
      content: (
        <div>
          ...
          <div style={{ marginTop: '50px', display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px', maxWidth: '800px', margin: '50px auto' }}>
    ...
    },
    {
      ...
      content: (
        <div style={{ textAlign: 'left', maxWidth: '1000px', margin: '0 auto', fontSize: '0.8em' }}>
          ...
          <p style={{ marginBottom: '25px', fontSize: '0.95em', textAlign: 'center' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.85em' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr', gap: '5px', marginBottom: '8px', fontWeight: 'bold', borderBottom: '2px solid rgba(79, 195, 247, 0.5)', paddingBottom: '5px' }}>
                  ...
                  <div style={{ textAlign: 'center' }}>Latency</div>
                ...
                {[
                  ...
                  <div key={i} style={{ display: 'contents' }}>
                    ...
                    <div style={{ textAlign: 'center', padding: '3px 0' }}>{row.acc}</div>
                    <div style={{ textAlign: 'center', padding: '3px 0' }}>{row.lat}</div>
                    <div style={{ textAlign: 'center', padding: '3px 0' }}>{row.dev}</div>
                    <div style={{ textAlign: 'center', padding: '3px 0' }}>{row.ops}</div>
                  </div>
                ))}
              </div>
            </div>
