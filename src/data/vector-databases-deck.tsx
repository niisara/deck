      ...
      slides: [
        {
          ...
          title: 'Pinecone',
          content: (
        <div style={{ textAlign: 'left', margin: '0 auto', fontSize: '0.7em', color: '#69addb' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              ...
              <p style={{ lineHeight: '1.6', fontSize: '0.95em', color: '#f39c12' }}>
            ...
            <div>
              ...
              <p style={{ lineHeight: '1.6', fontSize: '0.95em',  color: '#e74c3c' }}>
      ...
      slides: [
        {
          ...
          title: 'Weaviate',
          content: (
        <div style={{ textAlign: 'left', margin: '0 auto', fontSize: '0.7em', color: '#24b15f' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#3498db', marginBottom: '10px' }}>
                <SvgIcon iconName="duo-diagram-project" sizeName="1x" darkModeInvert={true} />
      ...
      slides: [
        {
          ...
          title: 'Qdrant',
          content: (
        <div style={{ textAlign: 'left', margin: '0 auto', fontSize: '0.7em', color: '#9434bd' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#3498db', marginBottom: '10px' }}>
                <SvgIcon iconName="duo-diagram-project" sizeName="1x" darkModeInvert={true} />
      ...
      slides: [
        {
          ...
          title: 'Milvus',
          content: (
        <div style={{ textAlign: 'left', margin: '0 auto', fontSize: '0.7em', color: '#df8739' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#3498db', marginBottom: '10px' }}>
                <SvgIcon iconName="duo-diagram-project" sizeName="1x" darkModeInvert={true} />
      ...
      slides: [
        {
          ...
          title: 'Chroma',
          content: (
        <div style={{ textAlign: 'left', margin: '0 auto', fontSize: '0.7em', color: '#ed311f' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#3498db', marginBottom: '10px' }}>
                <SvgIcon iconName="duo-diagram-project" sizeName="1x" darkModeInvert={true} />
      ...
      slides: [
        {
          ...
          title: 'Redis Vector Store',
          content: (
        <div style={{ textAlign: 'left', margin: '0 auto', fontSize: '0.7em', color: '#0bc7a2' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#3498db', marginBottom: '10px' }}>
                <SvgIcon iconName="duo-diagram-project" sizeName="1x" darkModeInvert={true} />
      ...
      slides: [
        {
          ...
          title: 'Elasticsearch Vector',
          content: (
        <div style={{ textAlign: 'left', margin: '0 auto', fontSize: '0.7em', color: '#1888d1' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#3498db', marginBottom: '10px' }}>
                <SvgIcon iconName="duo-diagram-project" sizeName="1x" darkModeInvert={true} />
      ...
      slides: [
        {
          ...
          title: 'Vespa',
          content: (
        <div style={{ textAlign: 'left', margin: '0 auto', fontSize: '0.7em', color: '#d96518' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#3498db', marginBottom: '10px' }}>
                <SvgIcon iconName="duo-diagram-project" sizeName="1x" darkModeInvert={true} />
      ...
      slides: [
        {
          ...
          title: 'MongoDB Vector Search',
          content: (
        <div style={{ textAlign: 'left', margin: '0 auto', fontSize: '0.7em', color: '#17b35a' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#3498db', marginBottom: '10px' }}>
                <SvgIcon iconName="duo-diagram-project" sizeName="1x" darkModeInvert={true} />
      ...
      slides: [
        {
          ...
          title: 'LanceDB',
          content: (
        <div style={{ textAlign: 'left', margin: '0 auto', fontSize: '0.7em', color: '#8a9395' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              <h4 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#3498db', marginBottom: '10px' }}>
                <SvgIcon iconName="duo-diagram-project" sizeName="1x" darkModeInvert={true} />
