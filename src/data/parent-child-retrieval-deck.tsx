  ...
  slides: [
    {
      ...
      content: (
        <div>
          ...
          <div style={{ marginTop: '50px', display: 'flex', gap: '30px', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap' }}>
    ...
    },
    {
      ...
      content: (
        <div style={{ textAlign: 'left', maxWidth: '1100px', margin: '0 auto', fontSize: '0.75em' }}>
          ...
          <div style={{ marginTop: '25px', padding: '15px', background: 'rgba(79, 195, 247, 0.2)', borderRadius: '8px', textAlign: 'center' }}>
